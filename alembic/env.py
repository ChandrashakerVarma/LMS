...
from app.models import (
    ...
    candidate_m, job_posting_m, jobrole_m, shift_change_request_m,shift_roster_detail_m,
    user_shifts_m, workflow_m, notification_m,menu_m,role_right_m,shift_roster_m,week_day_m
)
