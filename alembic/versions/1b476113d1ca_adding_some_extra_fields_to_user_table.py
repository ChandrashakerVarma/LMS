"""adding some extra fields to user table

Revision ID: 1b476113d1ca
Revises: 31e074d24f40
Create Date: 2025-10-29 17:45:06.639088
...
revision: str = '1b476113d1ca'
down_revision: Union[str, Sequence[str], None] = '31e074d24f40'
...
def upgrade() -> None:
    ...
    op.alter_column('users', 'joining_date',
               ...
               type_=sa.Date(),
               existing_nullable=True)
    op.alter_column('users', 'relieving_date',
               existing_type=mysql.DATETIME(),
               type_=sa.Date(),
               existing_nullable=True)
    op.alter_column('users', 'address',
               ...
               type_=sa.String(length=255),
               existing_nullable=True)
    op.alter_column('users', 'biometric_id',
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'users', type_='foreignkey')
    op.create_foreign_key(op.f('fk_users_branch_id'), 'users', 'branches', ['branch_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key(op.f('users_ibfk_2'), 'users', 'organizations', ['organization_id'], ['id'], ondelete='SET NULL')
